...
@section('content')
    <div class="auth-wrap">
        <div class="auth-card">
            ...
            @if (session('status'))
                <div
                    style="background:var(--green-light);color:var(--green);padding:12px 16px;border-radius:var(--r-md);font-size:13px;margin-bottom:20px;border:1px solid rgba(34,197,94,.2)">
                    {{ session('status') }}
                </div>
            @endif
