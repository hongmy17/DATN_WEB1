...
@push('styles')
<style>
.wishlist-empty { text-align: center; padding: 80px 24px; background: var(--bg-alt); border-radius: var(--r-2xl); }
...
<div class="container section">
  ...
  <div class="d-flex justify-between align-center mb-32">
    <h1 class="heading-1">Sản phẩm <span class="text-accent">yêu thích</span> ♥</h1>
  </div>
    ...
    <div class="grid-4">
      ...
      <div class="product-card">
        <div class="product-card__thumb">
          ...
          <div class="product-card__img">📱</div>
          <div class="product-card__actions">
            <button class="btn btn-primary btn-sm" onclick="Cart.add({id:2,name:'iPhone 15',price:32990000,img:'📱'})">+ Giỏ hàng</button>
          </div>
        </div>
        <div class="product-card__body">
          <div class="product-card__brand">Apple</div>
