  ...
  <div class="account-layout">
    ...
    <div>
      ...
      <div style="text-align:center;padding:80px 24px;background:var(--bg-alt);border:1px solid var(--border-soft);border-radius:var(--r-xl)">
        <svg width="56" height="56" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round" style="color:var(--border);margin:0 auto 14px"><path d="M9 11l3 3L22 4"/><path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11"/></svg>
        <p style="font-size:15px;font-weight:600;margin-bottom:6px">Chưa có đơn hàng nào</p>
        <p style="font-size:13.5px;color:var(--ink-3);margin-bottom:20px">Mua sắm ngay để có đơn hàng đầu tiên!</p>
